...
from advanced_solver import AdvancedSolver, Repair
import sys
import argparse
...
def main(input_file, rules_file="domain_rules.lp"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rules", "-r", dest="rules_file", default="domain_rules.lp",
                        help="Path to rules file (default: domain_rules.lp)")
