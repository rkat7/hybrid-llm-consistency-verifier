...
from src.extractors.extended_custom_extractor import extract_facts
from src.solvers.simple_check import check_consistency
from src.solvers.simple_repair import suggest_repairs

def run_test(input_file, rules_file="src/domain_rules/advanced_domain_rules.lp", output_dir="results", verbose=False):
...
def run_batch_tests(test_dir, rules_file="src/domain_rules/advanced_domain_rules.lp", output_dir="results/batch_results"):
...
def main():
    ...
    parser.add_argument("--rules", "-r", default="src/domain_rules/advanced_domain_rules.lp", 
                        help="Rules file (default: src/domain_rules/advanced_domain_rules.lp)")
